...
dibujar_stitch:
	...
	sub sp, sp, #32 // guardar la direccion de retorno de la llamada en el stack
    stur lr, [sp, #24]
	stur x19, [sp, #16]
	stur x5, [sp, #8]
	stur x6, [sp]
...
//--
	...
	movz x23, 0xD8, lsl 16
	movk x23, 0x69B5, lsl 0	// negrou
	...
	movz x23, 0xB9, lsl 16
	movk x23, 0x0E0E, lsl 0	// negrou
	...
	movz x23, 0xE2, lsl 16
	movk x23, 0xA3EE, lsl 0	// negrou
